...
//	ip: 112
    Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost/bdcinemark", "postgres", "123456");
    String sql = "update usuario set password = ? where idusuario= 1";
